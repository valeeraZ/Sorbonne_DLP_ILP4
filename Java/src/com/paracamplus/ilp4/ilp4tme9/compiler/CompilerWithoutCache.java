...
public class CompilerWithoutCache extends com.paracamplus.ilp4.compiler.Compiler {

    public CompilerWithoutCache(IOperatorEnvironment ioe, IGlobalVariableEnvironment igve) {
        super(ioe, igve);
    }
