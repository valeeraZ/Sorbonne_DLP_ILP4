...
import com.paracamplus.ilp4.ilp4tme9.compiler.CompilerWithoutCache;
...
public class CompilerWithoutCacheTest extends com.paracamplus.ilp4.compiler.test.CompilerTest {
    ...
    public CompilerWithoutCacheTest(final File file) {
    	super(file);
    }    
    ...
    public void configureRunner(CompilerRunner run) throws CompilationException {
        ...
        CompilerWithoutCache compiler = new CompilerWithoutCache(ioe, gve);
